...
public class DialogoOpcionesInsertar extends JDialog {
    ...
    public void continuarAdicionPaciente() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "El código del paciente con relación al cual se va a realizar la adición debe ser un valor num�rico", "Adición Pacientes", JOptionPane.ERROR_MESSAGE);
        }
    }
