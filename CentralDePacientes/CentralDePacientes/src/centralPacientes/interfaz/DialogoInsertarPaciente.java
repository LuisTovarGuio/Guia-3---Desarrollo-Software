        ...
        if (comando.equals(AGREGAR)) {
            try {
                ...
                if (elCodigo < 0) {
                    ...
                    JOptionPane.showMessageDialog(this, "Debe ingresar la cl�nica del paciente", "Adición de Pacientes", JOptionPane.ERROR_MESSAGE);
                }
                ...
                JOptionPane.showMessageDialog(this, "El paciente con código " + codigo + " con relaci�n al cual se va a realizar la adición no se encuentra registrado", "Adición de Pacientes", JOptionPane.ERROR_MESSAGE);
            }
        }
